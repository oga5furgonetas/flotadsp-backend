...
export default function Planes() {
  ...
  const plans = [
    ...
    { tag: 'Starter', name: 'Starter', who: t('pl.who.s'), price: '29€', per: t('pl.mo'), cta: t('pl.choose'), href: '/registro', pop: false,
      feats: ['pl.feat.1c', 'pl.feat.25', 'pl.feat.insp'] },
    { tag: 'Pro ⭐', name: 'Pro', who: t('pl.who.p'), price: '79€', per: t('pl.mo'), cta: t('pl.choose'), href: '/registro', pop: true,
      feats: ['pl.feat.3c', 'pl.feat.unl', 'pl.feat.allm', 'pl.feat.prio'] },
    { tag: 'Flota', name: 'Flota', who: t('pl.who.f'), price: '149€', per: t('pl.mo'), cta: t('pl.choose'), href: '/registro', pop: false,

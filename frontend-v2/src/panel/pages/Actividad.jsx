...
const SEV_LABEL = { sin_danos: 'sin daños', leve: 'leve', moderado: 'moderado', grave: 'grave', critico: 'crítico', sin_analisis: 'sin análisis' }
...
export default function Actividad() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <h1 className="mb-4 flex items-center gap-2 text-xl font-bold"><Activity size={20} /> Actividad reciente</h1>
        ...
        {list.map((i) => {
          ...
          return (
            <div key={i.id} className="flex items-center gap-3 px-4 py-2.5 text-sm">
              ...
              <span className="text-dark-400">inspección · <span className={SEV_CLS[sev] || 'text-dark-400'}>{SEV_LABEL[sev] || sev}</span></span>

...
export const crearPlantillasWhatsapp = () => api.post('/whatsapp/plantillas/crear')
...
export const ordenesPorTaller = (center) =>
  api.get('/work-orders/por-taller', { params: centerParam(center) })
